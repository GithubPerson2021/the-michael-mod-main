...
HX_DECLARE_STACK_FRAME(_hx_pos_4e288e2989890fc6_24_new)
...
HXLINE(  31)		( ( ::Song)(__this) )->mania = 0;
HXLINE(  30)		( ( ::Song)(__this) )->speed = ((Float)1);
HXLINE(  29)		( ( ::Song)(__this) )->needsVoices = true;
HXLINE(  38)		( ( ::Song)(__this) )->song = song;
HXLINE(  39)		( ( ::Song)(__this) )->notes = notes;
HXLINE(  40)		( ( ::Song)(__this) )->bpm = bpm;
            	}
