...
HX_DECLARE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_294_new)
...
{
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_294_new)
HXLINE( 298)		( ( ::SongMetadata)(__this) )->songCharacter = HX_("",00,00,00,00);
HXLINE( 297)		( ( ::SongMetadata)(__this) )->week = 0;
HXLINE( 296)		( ( ::SongMetadata)(__this) )->songName = HX_("",00,00,00,00);
HXLINE( 302)		( ( ::SongMetadata)(__this) )->songName = song;
HXLINE( 303)		( ( ::SongMetadata)(__this) )->week = week;
HXLINE( 304)		( ( ::SongMetadata)(__this) )->songCharacter = songCharacter;
            	}
