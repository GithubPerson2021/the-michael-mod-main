...
class HXCPP_CLASS_ATTRIBUTES Controls_obj : public  ::flixel::input::actions::FlxActionSet_obj
{
	...
	public:
		...
		static ::Dynamic isGamepad_dyn();
		 ...
		 ::flixel::input::actions::FlxActionDigital _l1;
		 ::flixel::input::actions::FlxActionDigital _l1P;
		 ::flixel::input::actions::FlxActionDigital _l1R;
		 ::flixel::input::actions::FlxActionDigital _u;
		 ::flixel::input::actions::FlxActionDigital _uP;
		 ::flixel::input::actions::FlxActionDigital _uR;
		 ::flixel::input::actions::FlxActionDigital _r1;
		 ::flixel::input::actions::FlxActionDigital _r1P;
		 ::flixel::input::actions::FlxActionDigital _r1R;
		 ::flixel::input::actions::FlxActionDigital _l2;
		 ::flixel::input::actions::FlxActionDigital _l2P;
		 ::flixel::input::actions::FlxActionDigital _l2R;
		 ::flixel::input::actions::FlxActionDigital _d;
		 ::flixel::input::actions::FlxActionDigital _dP;
		 ::flixel::input::actions::FlxActionDigital _dR;
		 ::flixel::input::actions::FlxActionDigital _r2;
		 ::flixel::input::actions::FlxActionDigital _r2P;
		 ::flixel::input::actions::FlxActionDigital _r2R;
		 ::flixel::input::actions::FlxActionDigital _n0;
		 ::flixel::input::actions::FlxActionDigital _n1;
		 ::flixel::input::actions::FlxActionDigital _n2;
		 ::flixel::input::actions::FlxActionDigital _n3;
		 ::flixel::input::actions::FlxActionDigital _n4;
		 ::flixel::input::actions::FlxActionDigital _n5;
		 ::flixel::input::actions::FlxActionDigital _n6;
		 ::flixel::input::actions::FlxActionDigital _n7;
		 ::flixel::input::actions::FlxActionDigital _n8;
		 ::flixel::input::actions::FlxActionDigital _n0P;
		 ::flixel::input::actions::FlxActionDigital _n1P;
		 ::flixel::input::actions::FlxActionDigital _n2P;
		 ::flixel::input::actions::FlxActionDigital _n3P;
		 ::flixel::input::actions::FlxActionDigital _n4P;
		 ::flixel::input::actions::FlxActionDigital _n5P;
		 ::flixel::input::actions::FlxActionDigital _n6P;
		 ::flixel::input::actions::FlxActionDigital _n7P;
		 ::flixel::input::actions::FlxActionDigital _n8P;
		 ::flixel::input::actions::FlxActionDigital _n0R;
		 ::flixel::input::actions::FlxActionDigital _n1R;
		 ::flixel::input::actions::FlxActionDigital _n2R;
		 ::flixel::input::actions::FlxActionDigital _n3R;
		 ::flixel::input::actions::FlxActionDigital _n4R;
		 ::flixel::input::actions::FlxActionDigital _n5R;
		 ::flixel::input::actions::FlxActionDigital _n6R;
		 ::flixel::input::actions::FlxActionDigital _n7R;
		 ::flixel::input::actions::FlxActionDigital _n8R;
		...
		bool get_L1_P();
		::Dynamic get_L1_P_dyn();

		bool get_L1_R();
		::Dynamic get_L1_R_dyn();

		bool get_D1();
		::Dynamic get_D1_dyn();

		bool get_D1_P();
		::Dynamic get_D1_P_dyn();

		bool get_D1_R();
		::Dynamic get_D1_R_dyn();

		bool get_R1();
		::Dynamic get_R1_dyn();

		bool get_R1_P();
		::Dynamic get_R1_P_dyn();

		bool get_R1_R();
		::Dynamic get_R1_R_dyn();

		bool get_L2();
		::Dynamic get_L2_dyn();

		bool get_L2_P();
		::Dynamic get_L2_P_dyn();

		bool get_L2_R();
		::Dynamic get_L2_R_dyn();

		bool get_U1();
		::Dynamic get_U1_dyn();

		bool get_U1_P();
		::Dynamic get_U1_P_dyn();

		bool get_U1_R();
		::Dynamic get_U1_R_dyn();

		bool get_R2();
		::Dynamic get_R2_dyn();

		bool get_R2_P();
		::Dynamic get_R2_P_dyn();

		bool get_R2_R();
		::Dynamic get_R2_R_dyn();
		...
		bool get_N0_P();
		::Dynamic get_N0_P_dyn();

		bool get_N1_P();
		::Dynamic get_N1_P_dyn();

		bool get_N2_P();
		::Dynamic get_N2_P_dyn();

		bool get_N3_P();
		::Dynamic get_N3_P_dyn();

		bool get_N4_P();
		::Dynamic get_N4_P_dyn();

		bool get_N5_P();
		::Dynamic get_N5_P_dyn();

		bool get_N6_P();
		::Dynamic get_N6_P_dyn();

		bool get_N7_P();
		::Dynamic get_N7_P_dyn();

		bool get_N8_P();
		::Dynamic get_N8_P_dyn();

		bool get_N0_R();
		::Dynamic get_N0_R_dyn();

		bool get_N1_R();
		::Dynamic get_N1_R_dyn();

		bool get_N2_R();
		::Dynamic get_N2_R_dyn();

		bool get_N3_R();
		::Dynamic get_N3_R_dyn();

		bool get_N4_R();
		::Dynamic get_N4_R_dyn();

		bool get_N5_R();
		::Dynamic get_N5_R_dyn();

		bool get_N6_R();
		::Dynamic get_N6_R_dyn();

		bool get_N7_R();
		::Dynamic get_N7_R_dyn();

		bool get_N8_R();
		::Dynamic get_N8_R_dyn();
