...
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_44_loadFromJson,"Song","loadFromJson",0x10fda511,"Song.loadFromJson","Song.hx",44,0x775e99e9)
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_73_parseJSONshit,"Song","parseJSONshit",0x7c7ff6e2,"Song.parseJSONshit","Song.hx",73,0x775e99e9)
...
bool Song_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Song_obj::loadFromJson(::String jsonInput,::String folder){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_44_loadFromJson)
...
HXLINE(  69)		return ::Song_obj::parseJSONshit(rawJson);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Song_obj,loadFromJson,return )
 ...
 ::Dynamic Song_obj::parseJSONshit(::String rawJson){
            	HX_GC_STACKFRAME(&_hx_pos_4e288e2989890fc6_73_parseJSONshit)
...
static ::hx::StorageInfo Song_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsInt,(int)offsetof(Song_obj,mania),HX_("mania",f2,c0,1e,03)},
