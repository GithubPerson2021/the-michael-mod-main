...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_294_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",294,0x0d86f62d)
...
HXLINE( 298)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 297)		this->week = 0;
HXLINE( 296)		this->songName = HX_("",00,00,00,00);
HXLINE( 302)		this->songName = song;
HXLINE( 303)		this->week = week;
HXLINE( 304)		this->songCharacter = songCharacter;
            	}
