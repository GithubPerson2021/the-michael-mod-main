...
HXDLIN(  88)		::String _hx_tmp1 = ((HX_("loading ",24,de,81,cb) + ::Sys_obj::getCwd()) + HX_("assets\\replays\\",e9,6e,58,da));
...
HXLINE(  91)			::String text = (::Sys_obj::getCwd() + HX_("assets\\replays\\",e9,6e,58,da));
