...
HXLINE(  80)		::Dynamic this11 = ::Highscore_obj::songScores;
HXDLIN(  80)		return ( ( ::haxe::ds::StringMap)(this11) )->get_int(::Highscore_obj::formatSong(song,diff));
            	}
...
HXLINE(  88)		::Dynamic this11 = ::Highscore_obj::songScores;
HXDLIN(  88)		return ( ( ::haxe::ds::StringMap)(this11) )->get_int(::Highscore_obj::formatSong((HX_("week",f4,5f,f5,4e) + week),diff));
            	}
