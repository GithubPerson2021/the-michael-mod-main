...
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_94_inst,"Paths","inst",0x9186a526,"Paths.inst","Paths.hx",94,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_108_image,"Paths","image",0xc392f1fb,"Paths.image","Paths.hx",108,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_113_font,"Paths","font",0x8f8bbf2f,"Paths.font","Paths.hx",113,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_118_getSparrowAtlas,"Paths","getSparrowAtlas",0x5a1f05f5,"Paths.getSparrowAtlas","Paths.hx",118,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_123_getPackerAtlas,"Paths","getPackerAtlas",0xa8de8c4f,"Paths.getPackerAtlas","Paths.hx",123,0x309ea470)
...
::String Paths_obj::inst(::String song){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_94_inst)
HXLINE(  95)		 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN(  95)		::String _hx_tmp1 = (((HX_("songs:assets/songs/",c1,ed,e6,7e) + song.toLowerCase()) + HX_("/Inst.",f9,6e,13,1c)) + HX_("ogg",4f,94,54,00));
HXDLIN(  95)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source/Paths.hx",64,c7,bd,1c),95,HX_("Paths",0e,7b,84,50),HX_("inst",c6,43,bb,45)));
HXLINE(  96)		bool _hx_tmp2;
HXDLIN(  96)		if ((song.toLowerCase() == HX_("whats-new",82,26,e5,c2))) {
HXLINE(  96)			_hx_tmp2 = ::Main_obj::drums;
            		}
            		else {
HXLINE(  96)			_hx_tmp2 = false;
            		}
HXDLIN(  96)		if (_hx_tmp2) {
HXLINE(  98)			return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + song.toLowerCase()) + HX_("/Fuck.",e8,03,74,66)) + HX_("ogg",4f,94,54,00));
            		}
            		else {
HXLINE( 102)			return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + song.toLowerCase()) + HX_("/Inst.",f9,6e,13,1c)) + HX_("ogg",4f,94,54,00));
            		}
...
::String Paths_obj::image(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_108_image)
HXDLIN( 108)		return ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            	}
...
::String Paths_obj::font(::String key){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_113_font)
HXDLIN( 113)		return (HX_("assets/fonts/",37,ff,a5,9c) + key);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Paths_obj,font,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames Paths_obj::getSparrowAtlas(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_118_getSparrowAtlas)
HXDLIN( 118)		::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 118)		return ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Paths_obj,getSparrowAtlas,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames Paths_obj::getPackerAtlas(::String key,::String library){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_123_getPackerAtlas)
HXDLIN( 123)		::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 123)		return ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSpriteSheetPacker(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library));
            	}
