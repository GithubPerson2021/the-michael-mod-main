...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'where-are-you':
				...
				dialogue = [
					"Heya",
					"I'm looking for someones dog that got lost\nin this mansion",
					"His name is Scooby, have you seen him\nor anything?",
					...
					"bop bee bap", //Clean ur fucking kitchen.
					"Hmm...",
			...
			case 'eruption':
				dialogue = [
					"Whoops! My powers went bonkers!",
					"I'm sorry, I don't wanna make it\nhard for you or anything.",
			...
			case 'kaio-ken':
				dialogue = [
					"Dang you are good!",
					"I don't want to bore you, so I'll\nsing faster this time",
			...
			case 'whats-new':
				dialogue = [
					...
					"boop bap",
					"Sing Again?", //Did I fuckin stutter? Bring it on bitch, I'm tired of your shit. I didn't even care for your dog.
					"Maybe singing louder will help.",
					"Maybe..",
					"Alright, here we go."
				];
				dface = [
			...
			case 'blast':
				dialogue = [
					...
					"...",
					"...",
					"Scooby's his closest friend you know",
					"He has been together with him for the last 70 years!",
					"He stopped our aging when I was like 3.",
					"He didn't do the same to his other friends because it\nwould be selfish for them to not let them\nrest and stuff...",
					"But Scooby was so insistent.\nhe told Shaggy he'd never regret his decision if\nit meant to spend eternity side by side.",
					"Now Scooby the only one he has left...",
					"beep bee bap!",
					"...",
					"Let me just-"
				];
		...
		var kadeEngineWatermark = new FlxText(4,FlxG.height - 4,0,SONG.song + " " + (storyDifficulty == 2 ? "Hard" : storyDifficulty == 1 ? "Normal" : "Easy") + " - MICHAEL ENGINE " + MainMenuState.kadeEngineVer, 16);
	...
	var sh_kill_line:String = "Oh and next time you cut his dog in half I'm\nnot gonna pretend like singing is\nmy only option again.";
	public function csDial(csIndex:String)
	{
		switch (csIndex)
		{
			case 'found_scooby':
				dialogue = [
					"Hey where were you?!",
					"I don't know Michael, this mansion\nis really big!",
			...
			case "sh_bye":
				dialogue = [
					...
					"And if Shaggy's gonna be there, I can't\nmiss it.",
