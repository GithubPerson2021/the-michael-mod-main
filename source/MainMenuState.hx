...
class MainMenuState extends MusicBeatState
{
	...
	public static var kadeEngineVer:String = "MICHAEL EDITION";
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				{
					#if linux
					Sys.command('/usr/bin/xdg-open', ["https://static.wikia.nocookie.net/dogelore/images/d/db/EA113981-AB35-4738-A817-A6ABAEF2D387.png/revision/latest?cb=20200418191930", "&"]);
					#else
					FlxG.openURL('https://static.wikia.nocookie.net/dogelore/images/d/db/EA113981-AB35-4738-A817-A6ABAEF2D387.png/revision/latest?cb=20200418191930');
					#end
				}
				else
				{
